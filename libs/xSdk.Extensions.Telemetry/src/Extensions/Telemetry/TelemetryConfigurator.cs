...
//    private static void Initialize(TelemetryType type, Action<EnvironmentSetup, TelemetryOptions, ResourceBuilder> configure)
//    {
...
//    private static void Configure(OtlpExporterOptions options, TelemetryOptions telemetrySetup)
//    {
