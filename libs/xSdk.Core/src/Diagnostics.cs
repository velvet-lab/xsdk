...
/// <summary>
/// Zentrale Diagnostics-Klasse für das Paket <c>xSdk.Core</c> (ADR-014).
...
internal static class Diagnostics
{
    ...
    internal const string SourceName = "xSdk";

    /// <summary>Gemeinsame <see cref="ActivitySource"/> für alle Klassen in <c>xSdk.Core</c>.</summary>
    internal static readonly ActivitySource Source = new(SourceName);

    /// <summary>Gemeinsamer <see cref="Meter"/> für alle Klassen in <c>xSdk.Core</c>.</summary>
