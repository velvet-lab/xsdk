    ...
    internal class TestMapper : Profile
    {
        public TestMapper()
        {
            this.CreateMap<TestEntity, TestModel>()
                ...
                .ForMember(x => x.Id, opts => opts.ConvertUsing(new ObjectIdConverter.ToModelProperty()))
                ...
                .ForMember(x => x.Id, opts => opts.ConvertUsing(new ObjectIdConverter.ToEntityProperty()))
                .ForMember(x => x.PrimaryKey, opts => opts.Ignore());
        }
    }
}
